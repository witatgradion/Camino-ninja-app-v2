-- Stage planner schema at v9 as shipped on release/2.2.410.
-- Every stage_uuid is backfilled (v9 healed any NULL/blank rows
-- inherited from v8). The `trail_route_ids` column does NOT exist
-- here — that column was added by feature/combining-trails on its
-- own pre-merge v9, which release/2.2.410 users never ran. The
-- v10 migration must add it idempotently so this v9-shaped DB
-- reaches the current schema with no data loss.
...
-- Plan 1: 3 stages, all uuids present (healthy post-v9 state).
...
-- Plan 2: 2 stages, all uuids present.
INSERT INTO stage_plans (
  id, route_id, created_at, updated_at, is_imported, name,
  uuid, starting_date
) VALUES (
  2, 20, '2024-07-01T10:00:00.000Z', '2024-07-01T10:00:00.000Z',
  0, 'Plan two',
...
INSERT INTO stages (
  ...
  (10, 2, 20, 'stage-uuid-0010', '2024-07-05', 201, 202,
   '2024-07-01T10:00:00.000Z', 1, 3),
  (11, 2, 20, 'stage-uuid-0011', '2024-07-08', 202, 203,
   '2024-07-01T10:00:00.000Z', 2, 1);

-- Plan 3: 1 stage, uuid present.
INSERT INTO stage_plans (
  id, route_id, created_at, updated_at, is_imported, name,
  uuid, starting_date
) VALUES (
  3, 30, '2024-08-01T00:00:00.000Z', '2024-08-01T00:00:00.000Z',
  0, 'Plan three',
...
INSERT INTO stages (
  ...
  (20, 3, 30, 'stage-uuid-0020', 301, 302,
   '2024-08-01T00:00:00.000Z', 1, 1);
