...
Future<void> main() async {
  ...
  await AppEnv.load(Flavor.development);
  ...
  // App Check errors are recorded as non-fatal.
  ...
  setupDependencies(baseUrl: AppEnv.baseUrl);

  // Register NotificationService for dev flavor only.
  // Must be after setupDependencies so DI is ready, and
  // appRouter is inside a closure so it's not eagerly
  // evaluated.
  GetIt.instance
