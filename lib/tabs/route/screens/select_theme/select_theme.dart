          ...
          body: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context).themeAvailable,
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isSelected = appState.theme == theme;
                    return InkWell(
                      onTap: () {
                        context.read<AppCubit>().onChangeTheme(theme: theme);
                        GetIt.instance<IAnalyticsService>().track(
                          ThemeChangedEvent(theme: theme.name),
                        );
                      },
                      child: SizedBox(
                        height: 52,
